...
namespace Software_Industrial
{
    public partial class empleados : Form
    {
        ...
        private void consulta()
        {
            ...
            string query = "select idemple, nomemple as 'Nombre', apellemple as 'Apellido', dpi as 'DPI', edad as 'Edad' , genero as 'Genero', nacionalidad as 'Nacionalidad', estadocivil as 'Estado Civil', tel as 'Telefono', direc as 'Direccion', nosegsocial as 'Seguro Social', licencia as 'Licencia'  from tbempleado";
            empleado_dgw.DataSource = db.consulta_DataGridView(query);
            empleado_dgw.Columns[0].Visible = false;
            empleado_dgw.Focus();
        }
        ...
        private void empleado_dgw_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
