...
namespace Software_Industrial
{
    public partial class ausencias : Form
    {
        ...
        {
            //ausencia_dgw.DataSource = db.consulta_DataGridView("select *from tbtipoausencia");
            string query = "select tbtipoausencia_id as COMO,tbtipoausencia_descripcion as Descripcion ,tbtipoausencia_tiempo as Tipo from tbtipoausencia";
            ausencia_dgw.DataSource = db.consulta_DataGridView(query);
            ausencia_dgw.Columns[0].Visible = false;
            ausencia_dgw.Focus();
        }
